...
def mobile_page(request, sub_cat_id=None, min_range=0, max_range=200000):
    if sub_cat_id:
    ...
    return render(request,"mobile_page.html", {"mobiles":mobiles, "subCats":subCat})

def accessory_page(request,cat_id=None):
    if cat_id:
